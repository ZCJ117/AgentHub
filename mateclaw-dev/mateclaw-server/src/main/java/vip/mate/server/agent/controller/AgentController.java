...
import vip.mate.domain.agent.vo.AgentCapabilitiesVO;
import vip.mate.domain.agent.vo.AgentStatsVO;
...
import vip.mate.domain.workspace.core.service.WorkspaceService;
...
public class AgentController {
    ...
    public R<java.util.Map<String, String>> uploadAvatar(
    ...
    @GetMapping("/{id}/stats")
    @RequireWorkspaceRole("viewer")
    public R<vip.mate.domain.agent.vo.AgentStatsVO> getStats(@PathVariable Long id) {
