package vip.mate.server.memory.fact;
...
import vip.mate.domain.memory.fact.model.FactEntity;
import vip.mate.domain.memory.fact.projection.FactProjectionBuilder;
import vip.mate.domain.memory.fact.query.FactQueryService;
import vip.mate.domain.memory.fact.repository.FactContradictionMapper;
import vip.mate.domain.memory.fact.repository.FactMapper;
...
import vip.mate.domain.workspace.document.model.WorkspaceFileEntity;
