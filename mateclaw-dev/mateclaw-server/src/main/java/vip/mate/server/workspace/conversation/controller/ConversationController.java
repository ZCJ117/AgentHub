package vip.mate.server.workspace.conversation;
...
public class ConversationController {
    ...
    public R<?> listMessages(@PathVariable String conversationId,
        ...
        // 分页模式
        java.util.List<vip.mate.domain.workspace.conversation.model.MessageEntity> messages;
        boolean hasMore;
        ...
        java.util.List<vip.mate.domain.workspace.conversation.vo.MessageVO> views =
