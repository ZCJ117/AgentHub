package vip.mate.server.channel;
...
import vip.mate.domain.channel.ChannelAdapter;
import vip.mate.domain.channel.ChannelManager;
import vip.mate.infra.channel.dingtalk.DingTalkAppRegistrationService;
import vip.mate.infra.channel.dingtalk.DingTalkChannelAdapter;
import vip.mate.infra.channel.discord.DiscordChannelAdapter;
import vip.mate.infra.channel.feishu.FeishuAppRegistrationService;
import vip.mate.infra.channel.feishu.FeishuChannelAdapter;
import vip.mate.infra.channel.qrcode.util.QrCodeImageEncoder;
import vip.mate.infra.channel.telegram.TelegramChannelAdapter;
import vip.mate.infra.channel.weixin.ILinkClient;
...
public class ChannelWebhookController {
    ...
    public ResponseEntity<Map<String, Object>> slackWebhook(@RequestBody Map<String, Object> payload) {
        ...
        if (adapter.isPresent() && adapter.get() instanceof vip.mate.infra.channel.slack.SlackChannelAdapter slack) {
