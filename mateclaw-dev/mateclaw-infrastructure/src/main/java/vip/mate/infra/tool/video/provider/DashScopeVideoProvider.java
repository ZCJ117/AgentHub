package vip.mate.infra.tool.video.provider;
...
import vip.mate.domain.tool.video.VideoCapability;
import vip.mate.domain.tool.video.VideoGenerationProvider;
import vip.mate.domain.tool.video.VideoGenerationRequest;
import vip.mate.domain.tool.video.VideoProviderCapabilities;
import vip.mate.domain.tool.video.VideoSubmitResult;
