package vip.mate.infra.channel.wecom;
...
public class WeComChannelAdapter extends AbstractChannelAdapter {
     ...
     * to build the {@link vip.mate.domain.channel.notification.ApprovalNotice}
     ...
     */
    private final vip.mate.infra.channel.wecom.cards.WeComCardDispatcher cardDispatcher;
    ...
    public WeComChannelAdapter(ChannelEntity channelEntity,
                               ...
                               vip.mate.domain.channel.notification.ApprovalNotificationService approvalNotificationService,
                               vip.mate.infra.channel.wecom.cards.WeComCardDispatcher cardDispatcher,
     ...
     * {@link vip.mate.infra.channel.wecom.cards.WeComCardKind} based on the
    ...
    public void sendApprovalNotice(String targetId,
        ...
        var kindOpt = cardDispatcher.lookupByMessageType(
                vip.mate.infra.channel.wecom.cards.tool_guard.ToolGuardCardKindFactory.MESSAGE_TYPE);
        if (kindOpt.isEmpty()) {
            super.sendApprovalNotice(targetId, notice);
            return;
        }
        ...
        } catch (vip.mate.infra.channel.cards.CardOversizedException oversized) {
    ...
    public void renderAndSend(String targetId, String content) {
        ...
        int maxLen = vip.mate.domain.channel.ChannelMessageRenderer.PLATFORM_LIMITS.getOrDefault(getChannelType(), 2048);

        List<String> segments = vip.mate.domain.channel.ChannelMessageRenderer.renderForChannel(
