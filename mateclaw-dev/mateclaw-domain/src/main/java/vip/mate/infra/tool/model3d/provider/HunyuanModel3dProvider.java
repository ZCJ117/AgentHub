package vip.mate.infra.tool.model3d.provider;
...
import vip.mate.domain.system.model.SystemSettingsDTO;
import vip.mate.domain.task.AsyncTaskService.TaskPollResult;
import vip.mate.domain.tool.model3d.Model3dCapability;
import vip.mate.domain.tool.model3d.Model3dGenerationProvider;
import vip.mate.domain.tool.model3d.Model3dGenerationRequest;
import vip.mate.domain.tool.model3d.Model3dProviderCapabilities;
import vip.mate.domain.tool.model3d.Model3dSubmitResult;
 ...
 *   <li>Concurrency: 1 task by default — {@link vip.mate.domain.tool.ConcurrencyUnsafe} on the tool ensures the agent doesn't fire two in parallel</li>
 * </ul>
 *
