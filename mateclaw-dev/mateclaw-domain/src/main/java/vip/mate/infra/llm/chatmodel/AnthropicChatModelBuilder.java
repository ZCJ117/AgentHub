package vip.mate.infra.llm.chatmodel;
...
import vip.mate.domain.llm.cache.AnthropicCacheOptionsFactory;
...
public class AnthropicChatModelBuilder implements ChatModelBuilder {
    ...
    /**
     * Overload — accepts a per-model read-timeout override
     * (seconds). Null / zero / negative falls back to {@link vip.mate.infra.llm.chatmodel.HttpTimeouts#DEFAULT_READ_TIMEOUT}
    ...
    static RestClient.Builder applyHttpTimeouts(RestClient.Builder builder, Integer readTimeoutOverride) {
        HttpClient httpClient = HttpClient.newBuilder()
                .connectTimeout(vip.mate.infra.llm.chatmodel.HttpTimeouts.CONNECT_TIMEOUT)
                .build();
        JdkClientHttpRequestFactory rf = new JdkClientHttpRequestFactory(httpClient);
        rf.setReadTimeout(vip.mate.infra.llm.chatmodel.HttpTimeouts.resolveReadTimeout(readTimeoutOverride));
    ...
    static WebClient.Builder applyHttpTimeoutsToWebClient(WebClient.Builder builder, Integer readTimeoutOverride) {
        ...
        connector.setReadTimeout(vip.mate.infra.llm.chatmodel.HttpTimeouts.resolveReadTimeout(readTimeoutOverride));
