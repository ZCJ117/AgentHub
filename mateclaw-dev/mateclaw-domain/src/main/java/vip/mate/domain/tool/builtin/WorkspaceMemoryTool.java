...
import vip.mate.domain.workspace.document.MemorySearchHit;
...
public class WorkspaceMemoryTool {
    ...
    @vip.mate.domain.tool.ConcurrencyUnsafe("workspace memory write — concurrent writes to the same file would clobber each other")
    @Tool(description = """
    ...
    @vip.mate.domain.tool.ConcurrencyUnsafe("workspace memory edit — find/replace must serialize per file")
    @Tool(description = """
