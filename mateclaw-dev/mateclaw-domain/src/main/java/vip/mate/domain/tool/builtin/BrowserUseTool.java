...
import vip.mate.infra.tool.browser.BrowserLauncher;
import vip.mate.infra.tool.browser.UrlSafetyChecker;
...
public class BrowserUseTool {
    ...
    public BrowserUseTool(vip.mate.infra.channel.web.ChatStreamTracker streamTracker,
