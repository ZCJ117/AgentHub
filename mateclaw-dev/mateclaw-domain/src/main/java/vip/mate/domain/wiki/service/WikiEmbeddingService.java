...
import vip.mate.infra.llm.embedding.EmbeddingModelFactory;
...
import vip.mate.domain.system.repository.SystemSettingMapper;
import vip.mate.domain.wiki.WikiProperties;
import vip.mate.domain.wiki.model.WikiChunkEntity;
import vip.mate.domain.wiki.model.WikiKnowledgeBaseEntity;
import vip.mate.domain.wiki.model.WikiPageEntity;
import vip.mate.domain.wiki.repository.WikiChunkMapper;
import vip.mate.domain.wiki.repository.WikiPageMapper;
import vip.mate.domain.wiki.repository.WikiRawMaterialMapper;
...
public class WikiEmbeddingService {
    ...
    private final vip.mate.domain.llm.service.ModelProviderService modelProviderService;
    ...
    private vip.mate.domain.wiki.job.WikiEmbeddingProviderFailingException circuitOpen(
        ...
        return new vip.mate.domain.wiki.job.WikiEmbeddingProviderFailingException(message, failures, remaining);
    }
