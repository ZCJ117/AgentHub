package vip.mate.domain.memory.scheduler;
...
import vip.mate.domain.memory.service.MemoryEmergenceService;
...
public class DreamingScheduler {
    ...
    public void runDreaming() {
        ...
        for (AgentEntity agent : agents) {
            ...
            try {
                emergenceService.consolidate(agent.getId(), vip.mate.domain.memory.service.DreamMode.NIGHTLY, null);
                success++;
            } catch (Exception e) {
                failed++;
