...
public class ActionNode implements NodeAction {
    ...
    private final vip.mate.infra.channel.web.ChatStreamTracker streamTracker;

    public ActionNode(ToolExecutionExecutor executor) {
        this(executor, null);
    }

    public ActionNode(ToolExecutionExecutor executor, vip.mate.infra.channel.web.ChatStreamTracker streamTracker) {
    ...
    public Map<String, Object> apply(OverAllState state) throws Exception {
        ...
        vip.mate.domain.agent.context.ChatOrigin origin = accessor.chatOrigin();
