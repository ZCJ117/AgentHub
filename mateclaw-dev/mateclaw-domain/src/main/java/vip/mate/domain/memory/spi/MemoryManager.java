package vip.mate.domain.memory.spi;

import io.micrometer.core.instrument.MeterRegistry;
import lombok.extern.slf4j.Slf4j;
import org.springframework.stereotype.Component;
import vip.mate.domain.memory.MemoryProperties;
import vip.mate.domain.memory.spi.decorator.MetricsMemoryProvider;
import vip.mate.domain.memory.spi.decorator.RetryableMemoryProvider;
...
public class MemoryManager {
     ...
     * @throws IllegalStateException if an external provider is already registered
     */
