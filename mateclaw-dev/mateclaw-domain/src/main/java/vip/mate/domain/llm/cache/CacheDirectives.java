package vip.mate.domain.llm.cache;
...
public record CacheDirectives(
        ...
        CacheTtl ttl,
        vip.mate.domain.llm.model.ModelProtocol protocol) {
    ...
    public static CacheDirectives empty(vip.mate.domain.llm.model.ModelProtocol protocol) {
