package vip.mate.domain.tool.service;
...
import vip.mate.infra.tool.mcp.runtime.McpHashCollisionDetector;
...
public class AvailableToolService {
     ...
     * {@link vip.mate.domain.tool.mcp.service.McpServerService}. Returns an empty
