...
import vip.mate.domain.skill.runtime.SkillSecurityService;
import vip.mate.domain.skill.runtime.SkillValidationResult;
...
public class SkillManageTool {
    ...
    @vip.mate.domain.tool.ConcurrencyUnsafe("create/edit/patch/delete on the shared skill registry; concurrent ops on the same skill name race")
    @Tool(description = """
