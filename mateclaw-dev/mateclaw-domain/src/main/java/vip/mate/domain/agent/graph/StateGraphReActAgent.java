...
public class StateGraphReActAgent extends BaseAgent implements StructuredStreamCapable {
    ...
    private Map<String, Object> buildInitialState(String userMessage, String conversationId) {
        ...
        String thinkingLevel = vip.mate.infra.llm.chatmodel.ThinkingLevelHolder.get();
        ...
        if (currentTurn.routingDecision() != null
                && currentTurn.routingDecision().strategy() != vip.mate.domain.llm.routing.model.MultimodalRoutingDecision.Strategy.NONE
        ...
        vip.mate.domain.agent.context.ChatOrigin origin = vip.mate.domain.agent.context.ChatOriginHolder.get();
