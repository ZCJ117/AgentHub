package vip.mate.domain.wiki.model;
 ...
 * {@link vip.mate.domain.wiki.hotcache.HotCacheContent}.
 */
@Data
...
public class WikiHotCacheEntity {
    ...
    /** {@link vip.mate.domain.wiki.hotcache.HotCacheUpdateReason#name()} for the most recent rebuild. */
