package vip.mate.domain.memory.fact.projection;
...
import vip.mate.domain.memory.fact.extraction.CompositeEntityExtractor;
import vip.mate.domain.memory.fact.extraction.ExtractedFact;
