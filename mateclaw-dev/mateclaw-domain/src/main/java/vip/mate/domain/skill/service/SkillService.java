package vip.mate.domain.skill.service;
...
import vip.mate.domain.skill.event.SkillRemovedEvent;
import vip.mate.domain.skill.lifecycle.SkillLifecycleService;
import vip.mate.domain.skill.model.SkillEntity;
import vip.mate.domain.skill.repository.SkillFileMapper;
...
import vip.mate.domain.skill.secret.SkillSecretService;
import vip.mate.domain.skill.workspace.SkillWorkspaceManager;
import vip.mate.domain.skill.workspace.SkillWorkspaceProperties;
...
public class SkillService {
    ...
    private vip.mate.domain.skill.runtime.SkillRuntimeService runtimeService;

    /**
     * 延迟注入 SkillRuntimeService 避免循环依赖
     */
    public void setRuntimeService(vip.mate.domain.skill.runtime.SkillRuntimeService runtimeService) {
