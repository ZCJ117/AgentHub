package vip.mate.domain.agent.context;
...
import vip.mate.domain.agent.graph.executor.ToolResultStorage;
...
public class ConversationWindowManager {
     ...
     * time.
     */
    private vip.mate.infra.channel.web.ChatStreamTracker streamTracker;

    @org.springframework.beans.factory.annotation.Autowired(required = false)
    public void setStreamTracker(vip.mate.infra.channel.web.ChatStreamTracker streamTracker) {
