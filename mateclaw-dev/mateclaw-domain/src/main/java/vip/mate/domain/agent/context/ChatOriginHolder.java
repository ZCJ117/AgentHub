 ...
 * graph state under {@link vip.mate.domain.agent.graph.state.MateClawStateKeys#CHAT_ORIGIN},
 * the rest of the runtime reads via the typed accessor — no further ThreadLocal
 * access. Mirrors {@link vip.mate.infra.llm.chatmodel.ThinkingLevelHolder}.
 */
