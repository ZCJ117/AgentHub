package vip.mate.domain.agent.graph.node;
...
import vip.mate.domain.agent.context.RuntimeContextInjector;
...
public class ReasoningNode implements NodeAction {
    ...
    private final vip.mate.domain.wiki.service.WikiContextService wikiContextService;
    ...
    public ReasoningNode(ChatModel chatModel, AgentToolSet toolSet, String reasoningEffort,
                         ...
                         ConversationWindowManager conversationWindowManager,
                         ChatStreamTracker streamTracker, int maxOutputTokens,
                         vip.mate.domain.wiki.service.WikiContextService wikiContextService) {
    ...
    public Map<String, Object> apply(OverAllState state) throws Exception {
        ...
        String workspaceBasePath = state.value(vip.mate.domain.agent.graph.state.MateClawStateKeys.WORKSPACE_BASE_PATH, "");
    ...
    List<Message> buildNonHistoryPrefix(String systemPrompt,
                                        ...
                                        String agentIdStr,
                                        String userMsg,
                                        vip.mate.domain.agent.context.ChatOrigin chatOrigin) {
