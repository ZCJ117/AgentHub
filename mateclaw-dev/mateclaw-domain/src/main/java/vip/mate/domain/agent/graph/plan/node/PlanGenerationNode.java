package vip.mate.domain.agent.graph.plan.node;
...
import vip.mate.domain.agent.graph.plan.state.PlanStateAccessor;
    ...
    public Map<String, Object> apply(OverAllState state) throws Exception {
        ...
        try {
            ...
            vip.mate.domain.agent.context.ChatOrigin chatOrigin =
                    state.<vip.mate.domain.agent.context.ChatOrigin>value(MateClawStateKeys.CHAT_ORIGIN)
