...
public class ShellExecuteTool {
    ...
    private final vip.mate.domain.system.I18nService i18n;
    ...
    @vip.mate.domain.tool.ConcurrencyUnsafe("shell command execution can mutate global state in ways the executor can't reason about")
    ...
    private static ProcessBuilder buildShellProcess(String command) {
        ...
        // 设置工作区活动目录
        java.nio.file.Path workingDir = vip.mate.domain.tool.guard.WorkspacePathGuard.getWorkingDirectory();
