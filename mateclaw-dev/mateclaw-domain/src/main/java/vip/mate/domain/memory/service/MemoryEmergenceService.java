package vip.mate.domain.memory.service;
...
import vip.mate.domain.memory.repository.DreamReportMapper;
...
public class MemoryEmergenceService {
    ...
    private final vip.mate.domain.memory.archive.MemoryArchiveService archiveService;
    private final ApplicationEventPublisher eventPublisher;
    private final vip.mate.domain.memory.fact.contradiction.ContradictionDetector contradictionDetector;
