package vip.mate.domain.skill.knowledge;
...
public class WikiSkillWrapperToolFactory {
     ...
     * building them. Used by {@link vip.mate.domain.skill.runtime.SkillPackageResolver}
