...
import vip.mate.domain.tool.image.*;
...
public class ImageGenerateTool {
    ...
    @vip.mate.domain.tool.ConcurrencyUnsafe("creates async tasks and persists generated artifacts; provider rate limits also forbid parallel calls")
