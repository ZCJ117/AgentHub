package vip.mate.domain.channel.service;
...
import vip.mate.infra.channel.feishu.FeishuClientFactory;
...
public class ChannelService {
     ...
     */
    private final ObjectProvider<vip.mate.domain.channel.tool.ChannelToolService> channelToolServiceProvider;
    ...
    private void invalidateChannelCaches(Long channelId, String channelType) {
        ...
        vip.mate.domain.channel.tool.ChannelToolService cts =
