...
import vip.mate.domain.system.featureflag.FeatureFlagService;
import vip.mate.domain.tool.builtin.DocumentExtractTool;
import vip.mate.domain.tool.image.vision.ImageVisionService;
import vip.mate.domain.tool.image.vision.VisionRequest;
import vip.mate.domain.tool.image.vision.VisionResult;
...
public class WikiRawMaterialService {
     ...
     * 供 {@link vip.mate.domain.wiki.service.WikiProcessingService#processRawMaterial(Long, boolean)}
