package vip.mate.domain.channel;
...
import vip.mate.infra.channel.dingtalk.DingTalkChannelAdapter;
import vip.mate.infra.channel.discord.DiscordChannelAdapter;
import vip.mate.infra.channel.feishu.FeishuChannelAdapter;
import vip.mate.infra.channel.leader.ChannelLeaderElection;
import vip.mate.infra.channel.leader.LeaderLease;
import vip.mate.domain.channel.model.ChannelEntity;
import vip.mate.infra.channel.qq.QQChannelAdapter;
import vip.mate.domain.channel.service.ChannelService;
import vip.mate.infra.channel.telegram.TelegramChannelAdapter;
import vip.mate.infra.channel.web.WebChannelAdapter;
import vip.mate.infra.channel.wecom.WeComChannelAdapter;
import vip.mate.infra.channel.weixin.WeixinChannelAdapter;
...
public class ChannelManager {
     ...
     */
    private final vip.mate.domain.channel.notification.ApprovalNotificationService approvalNotificationService;
     ...
     */
    private final vip.mate.infra.channel.wecom.cards.WeComCardDispatcher weComCardDispatcher;
     ...
     */
    private final vip.mate.infra.channel.wecom.WeComKeepaliveScheduler weComKeepaliveScheduler;

    /**
     * Feishu SDK-backed media uploader. Wired into
     * {@link vip.mate.infra.channel.feishu.FeishuChannelAdapter} so every
     ...
     */
    private final vip.mate.infra.channel.feishu.FeishuMediaUploader feishuMediaUploader;
     ...
     */
    private final vip.mate.infra.channel.media.GeneratedFileScrubber generatedFileScrubber;

    /**
     * Feishu CardKit streaming-card manager. Drives
     * {@link vip.mate.infra.channel.feishu.FeishuChannelAdapter}'s
     * {@code processStream} so the receiver sees text appearing
     * character-by-character instead of waiting for the full reply.
     */
    private final vip.mate.infra.channel.feishu.FeishuStreamingCardManager feishuStreamingCardManager;
     ...
     */
    private final vip.mate.infra.channel.feishu.cards.FeishuCardDispatcher feishuCardDispatcher;

    /**
     * Per-channelId SDK {@link com.lark.oapi.Client} cache. Injected into
     * {@link vip.mate.infra.channel.feishu.FeishuChannelAdapter} so inbound
     ...
     */
    private final vip.mate.infra.channel.feishu.FeishuClientFactory feishuClientFactory;
    ...
    ChannelAdapter createAdapter(ChannelEntity channel) {
        ...
        return switch (type) {
            ...
            case "feishu" -> new FeishuChannelAdapter(channel, messageRouter, objectMapper,
                    ...
                    feishuCardDispatcher, feishuClientFactory, generatedFileCache, null);
            ...
            case "slack" -> new vip.mate.infra.channel.slack.SlackChannelAdapter(channel, messageRouter, objectMapper);
            case "webchat" -> new vip.mate.infra.channel.webchat.WebChatChannelAdapter(channel, messageRouter, objectMapper);
