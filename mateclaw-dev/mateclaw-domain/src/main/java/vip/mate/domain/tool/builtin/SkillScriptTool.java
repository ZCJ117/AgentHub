...
import vip.mate.domain.skill.runtime.SkillFileAccessPolicy;
import vip.mate.domain.skill.runtime.SkillRuntimeService;
import vip.mate.domain.skill.runtime.SkillScriptExecutionService;
...
public class SkillScriptTool {
    ...
    @vip.mate.domain.tool.ConcurrencyUnsafe("script execution can have arbitrary side effects on the host process and filesystem")
    @Tool(description = """
